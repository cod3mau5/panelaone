            ...
            <table class="table table-condensed">
                ...
                <tfoot>
                    <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td><strong>${{number_format($reservas->sum('amount'),2)}}</strong></td>
                        </tr>
                </tfoot>
            </table>
        </div>
            ...
            $('.btn-cambiar-estatus').on('click', function () {
                ...
                if (changed) {
                    if (!$('#dataConfirmModal').length) {
                        $('body').append('<div class="modal fade" id="dataConfirmModal" tabindex="-1" role="dialog" aria-labelledby="dataConfirmLabel"><div class="modal-dialog modal-sm" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title" id="dataConfirmLabel">Confirmación</h4></div><div class="modal-body text-justify">Esta a punto de cambiar de estatus algunas reservaciones marcadas como pendientes a facturadas.<br> <strong>¿Esta seguro de continuar?</strong></div><div class="modal-footer"><a href="" class="btn btn-default" data-dismiss="modal">Cancelar</a><button class="btn btn-primary" id="dataConfirmOK">Continuar</button></div></div></div></div>');
                    } else {
